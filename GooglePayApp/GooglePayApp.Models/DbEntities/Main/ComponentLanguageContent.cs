...
namespace GooglePayApp.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(GooglePayApp.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(GooglePayApp.Models.Main.LanguageContent.ComponentLanguageContents))]
