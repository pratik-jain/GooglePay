...
//#region transactionId Prop
        @gridColumn({visible: true, columnIndex:1, allowSorting: true, headerKey: 'transactionId', keyColumn: false})
        transactionId : any;
//#endregion transactionId Prop


//#region senderId Prop
        @gridColumn({visible: true, columnIndex:2, allowSorting: true, headerKey: 'senderId', keyColumn: false})
        senderId : any;
...
//#region upiId Prop
        @gridColumn({visible: true, columnIndex:5, allowSorting: true, headerKey: 'upiId', keyColumn: false})
        upiId : any;
